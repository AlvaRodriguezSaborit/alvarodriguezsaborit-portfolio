...
export default function Hero() {
  ...
  return (
    <div>
      <section className="relative bg-linear-to-b from-[#FDFBF7] to-[#D5F899] flex flex-col overflow-hidden w-full">
        <div className="z-10 flex flex-col items-center text-center">
          ...
          <motion.h1
            className="mb-12 text-6xl font-bold tracking-tight text-black md:text-8xl"
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <motion.img
              src={yo}
              alt="Profile picture"
              className="p-0! object-cover h-auto grayscale hover:grayscale-0 transition-all duration-300 relative w-full max-w-md mt-4 shadow-xl self-end"
              initial={{ opacity: 0, y: 25 }}
              whileInView={{ opacity: 1, y: 0 }}
              whileHover={{ y: -25 }}
